...
export default function ResponsiveDrawer(props: Props) {
    ...
    const setMobileOpenToFalse = useBearStore((state) => state.setMobileOpenToFalse);
    const setIsClosingToTrue = useBearStore((state) => state.setIsClosingToTrue);
    const setIsClosingToFalse = useBearStore((state) => state.setIsClosingToFalse);
    ...
    const drawer = (
        <div>
            ...
            <List>
                {menuList.map((item) => (
                    <a href={item.link} key={item.text} style={{ textDecoration: 'none', color: 'inherit' }}>
